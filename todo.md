### Zadanie 1 (3p)
- [x] Przygotować środowisko do pracy z obrazami (zapisanymi w formatach: .bmp; .tif; .png;
.jpg) w dowolnym wybranym przez siebie języku programowania i środowisku.
- [x] Zapewnić opcje 
    - [x] wczytywania
    - [x] zapisywania
    - [x] duplikacji obrazu
...
### Zadanie 2 (2,5p)
- [x] Opracować algorytm i oprogramować funkcjonalność tworzenia tablicy LUT zawierającej
informację potrzebną do wyświetlenia, manipulacji lub analizy histogramu wczytanych
obrazów monochromatycznych i kolorowych. 
- [x] Zaimplementować narzędzie prezentacji
    - [ ] <del> (edycji - nieobowiązkowo) tablicy LUT
    - [x] + scrollbar

### Zadanie 3 (3,5p)
- [x] Opracować algorytm i uruchomić aplikację generowania histogramu jako wykresu słupkowego 
- [x] wraz z opisem statystycznych wielkości charakteryzujących obraz (proszę nie korzystać z procedur automatycznie generujących wykres słupkowy).
    - [x] średnia
...
### Zadanie 4 (2p)
Opracować algorytm i uruchomić funkcjonalności realizującą typowe operacje punktowe
jednoargumentowe na obrazach w odcieniach szarości:
- [x] negacja,
